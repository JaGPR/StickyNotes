    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        italicBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boldBtn.setBackground(getResources().getDrawable(R.drawable.rounded_edge));
                if (notesEdt.getTypeface().isItalic()) {
                    notesEdt.setTypeface(Typeface.DEFAULT);
                    italicBtn.setTextColor(getResources().getColor(R.color.black));
                    italicBtn.setBackgroundColor(getResources().getColor(R.color.black));
                    italicBtn.setBackground(getResources().getDrawable(R.drawable.rounded_edge));
                } else {
        ...
        underLineBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (notesEdt.getPaintFlags() == 8) {
                    underLineBtn.setTextColor(getResources().getColor(R.color.black));
                    underLineBtn.setBackground(getResources().getDrawable(R.drawable.rounded_edge));
